            ...
            <div class="ibox-content profile-content">
                <div class="ibox ">
                    <div class="form-group row {{ $errors->has('username') ? 'has-error' : '' }}">
                        <label class="col-lg-12 col-form-label">User Name <span class="text-danger">*</span></label>
                        <div class="col-lg-12">
                            <input type="text" placeholder="First Name"  value="{{$user->username}}" id="username" name="username" class="form-control" maxlength="30" required>
