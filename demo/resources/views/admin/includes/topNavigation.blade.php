<div class="row border-bottom">
    <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <li>
            ...
            <img class="rounded-circle" src="{!!  \Auth::user()->image !== '' ? asset("storage/image/".\Auth::user()->image) : asset('storage/image/default.png') !!}" alt="user-img" height="60px" width="60px">
            @else
            <img class="rounded-circle" src="{!! asset('storage/image/default.png') !!}" alt="user-img" accept="image/*" height="60px" width="60px">
            @endif
        </li>
        <li>
